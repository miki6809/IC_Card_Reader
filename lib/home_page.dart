...
final Map<int, String> _stationMap = {
  ...
  0x1AEAE0: '水族館前', // 市バス
  0x1AF070: '天文館', // 市バス （上り）
  0x1E8490: '鹿児島駅前', // 市電 I01 N01
  0x1E84A0: '桜島桟橋通', // 市電 I02 N02
  0x1E84B0: '水族館口', // 市電 I03 N03
  0x1E84C0: '市役所前', // 市電 I04 N04
  0x1E84D0: '朝日通', // 市電 I05 N05
  0x1E84E0: 'いづろ通', // 市電 I06 N06
  0x1E84F0: '天文館', // 市電 I07 N07
  0x1E8500: '高見馬場', // 市電 N08
  0x1E8510: '甲東中学校前', // 市電 N09
  0x1E8520: '新屋敷', // 市電 N10
  0x1E8530: '武之橋', // 市電 I11
  0x1E8540: '二中通', // 市電 N12
  0x1E8550: '荒田八幡', // 市電 N13
  0x1E8560: '騎射場', // 市電 I14
  0x1E8570: '鴨池', // 市電 I15
  0x1E8580: '郡元', // 市電 I16 N20
  0x1E85D0: '脇田', // 市電 I22
  0x1E8610: '郡元(南)', // 市電 I17
  ...
  0x450: '新上橋（下り）', // 林田バス
  0x550: '水族館前（下り）', // 林田バス
  0x581: 'イオンモール鹿児島（上り）', // 鹿児島交通
  0x681: '水族館前（上り）', // 鹿児島交通
  0x881: '鹿児島中央駅（下り）', // 鹿児島交通 0x4x
  0x902: '鴨池港（下り）', // 鹿児島交通
  0xD01: 'イオンモール鹿児島（下り）', // 鹿児島交通
};
...
class SuicaHistory {
  ...
  final String label;
  // RAPICA用拡張フィールド
  // 3バイト目のupper nibbleが1,2､3のときは4-6ﾊバイトが停留所コード
  // 4,5のときは3バイト目lower nibble＋4バイト目が停留所コード
  // 乗車・降車停留所の区別はないが、乗降を区別して表示しているので以下の変数を使用する
            ...
            for (var rule in identifiedCard.serviceRules) {
              ...
              for (int i = 0; i < maxIndex; i++) {
                ...
                if (isRapicaGroup) {
                  ...
                  // 参照するバイト位置が誤っていたので、B3 lower nibble + B4に修正
                  // また、これに伴い、路線情報としてB7-B9を参照するよう修正
                  station = ((b[3] & 0x0F) << 8) | b[4];
                  line = (b[7] << 16) | (b[8] << 8) | b[9];
                }
